...
If you want a refresher first:

<CardGrid>
  <LinkCard
    title="Semaphores and Mutexes"
    description="Binary semaphore patterns, ISR-safe APIs, and common mistakes."
    href="/guides/freertos/semaphores-mutexes/"
    icon="right-arrow"
  />
</CardGrid>
...
- Configure Port J for falling-edge interrupts on **PJ0** and **PJ1**
...
For more context and additional patterns:

<CardGrid>
  <LinkCard
    title="Software Timers Guide"
    description="Detailed explanation of create, start, callback rules, and task handoff patterns."
    href="/guides/freertos/software-timers/"
    icon="right-arrow"
  />
</CardGrid>
