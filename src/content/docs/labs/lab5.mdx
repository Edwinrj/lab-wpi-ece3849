...
<Aside type="danger">
We are assuming you are using Timer0 configured in Lab 4 to measure execution time. Make sure the `micros()` function is correctly implemented and returns time in microseconds.
</Aside>
