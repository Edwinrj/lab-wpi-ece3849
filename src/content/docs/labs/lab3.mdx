...
Our screen size is 128×128 pixels, and we’ll use 16×16 pixels per cell. This gives us an 8×8 grid for the snake to move around. 
...
Define the grid and cell sizes in `game.h`, plus the maximum length of the snake. With a 128×128 screen and 16×16 cells, there are 8×8 = 64 cells total, so the snake can be at most 64 segments long.
