---
title: Lab 0 - Environment Setup Guide
description: Complete guide for setting up the development environment for Lab 0 stopwatch and graphical menu project
---
...
Continue to [Lab 1](/guides/installccs/)
...
│   │   ├── timer.c/.h            # Timer configuration and ISR
│   │   ├── lcd.c/.h              # LCD display driver functions
│   │   └── adc.c/.h              # ADC configuration (if needed)
│   ├── 📁 ui/                    # User interface components
│   │   ├── menu.c/.h             # Menu system implementation
│   │   ├── stopwatch.c/.h        # Stopwatch functionality
│   │   └── display.c/.h          # Display management
│   ├── 📁 utils/                 # Utility functions
│   │   ├── debounce.c/.h         # Button debouncing utilities
│   │   ├── ringbuffer.c/.h       # Data structures
│   │   └── math_utils.c/.h       # Mathematical functions
...
└── 📁 tests/                     # Test files (optional)
    ├── test_timer.c              # Timer unit tests
    └── test_menu.c               # Menu system tests
```
...
| **V0** | Potentiometer | Contrast | 10kΩ pot for contrast control |
...
| **A** | 3.3V | Backlight Anode | Through 220Ω resistor |
...
```c
// Project Properties → Build → MSP430 Compiler → Optimization
