...
Compile and flash the project to your EK-TM4C1294XL board. You should see the green LED (D1) blinking every 2 seconds and the blue LED (D2) blinking rapidly every 200 milliseconds, demonstrating that FreeRTOS is running multiple tasks concurrently.

<Aside type="note">
  Make sure you have installed the latest version of Code Composer Studio before starting.
</Aside>
